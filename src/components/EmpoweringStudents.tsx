    ...
    <section className={cn("py-16 bg-gradient-to-b from-background to-muted/30", className)}>
      <div className="container px-4 mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Empowering Top Students around the World</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Student Success */}
          <div className="p-6 rounded-xl border bg-card shadow-sm hover:shadow-md transition-all">
