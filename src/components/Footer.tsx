      ...
      <div className="container px-4 py-12 md:py-16 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2">
            <Link to="/" className="inline-block text-primary mb-4 transition-opacity hover:opacity-90">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-200" aria-label="GitHub">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
