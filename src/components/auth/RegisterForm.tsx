...
export function RegisterForm() {
  const { signUp, updateUserProfile, checkEmailExists, signInWithGoogle } = useAuth();
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Create a new account to access Lex Grove</CardDescription>
      </CardHeader>
      
      {/* Google Sign-Up Option First */}
